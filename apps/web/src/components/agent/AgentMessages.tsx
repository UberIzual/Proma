      ...
      <ConversationContent>
        {messages.length === 0 && !streaming ? (
          ...
          <>
            ...
            {(streaming || smoothContent || smoothReasoning || toolActivities.length > 0) && (
              <Message from="assistant">
                <MessageHeader
                ...
                <MessageContent>
                  {smoothReasoning && (
                    <Reasoning isStreaming={streaming && !smoothContent} defaultOpen={true}>
                      <ReasoningTrigger />
                  ...
                  {smoothContent ? (
                    ...
                    streaming && toolActivities.length === 0 && !smoothReasoning && <MessageLoading />
                  )}
                </MessageContent>
              </Message>
            )}
