...
/**
 * 预处理 Markdown 内容，修复未闭合的语法
 * 确保流式过程中 Markdown 渲染正确
 */
...
export const MessageResponse = React.memo(
  function MessageResponse({ children, className }: MessageResponseProps): React.ReactElement {
    // 预处理内容，修复未闭合的 Markdown 语法
    const processedContent = React.useMemo(() => preprocessMarkdown(children), [children])
